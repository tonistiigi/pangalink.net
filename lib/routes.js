...
console.log(project)
    ...
    var accessToken = (req.query.access_token ||  (project && project.access_token) || "").toString().trim();
...
function serveAPIDeleteProject(req, res){
    var accessToken = (req.query.access_token || (req.body && req.body.access_token) || "").toString().trim(),
        projectId = (req.params.project || "").toString().trim();
